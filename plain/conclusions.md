...
A novelty check graded our findings against the published literature, and eleven claims survived as new. This page keeps the order of the original essay: the later part first, at 423 records, then the earlier part, at 137 records.
...
The flat report is correct about absence and blind to what the model ran. The expressive report is correct about the general emotion and invents the details. Neither model lies.
