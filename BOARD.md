...
| ◇ |  | trawl-03 | Trawl #3: gemma-4b (bf16) — clean effdim curve + gmail/ignition cross-check on a CAUSAL lens | 2026-07-17 gemma-12b's effdim was an 8-bit artifact; 4b is bf16 (causal). Confirms the family ignition-onset number and whether the gmail-is-boundary-furniture result holds on the small sibling. Cheap, closes the geometry gap. |
