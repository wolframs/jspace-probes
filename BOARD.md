...
| ◇ |  | trawl-02 | Trawl #2: gemma-12b — ignition-calibration cross-check + sediment census across the family | 2026-07-17 Does gemma's measured ignition also come in later than the fraction? Is the sensory-band sediment family-specific (qwen: porn spam + CSDN boilerplate) or universal-but-different-corpus? int8 caveat applies to any causal follow-up, not to readout curves. |
