...
| ◇ |  | apparatus-06 | Fig-29B ambiguity-commitment arm on qwen-27b: embedding-mixture alpha sweep, projection-share per layer (lens-free ignition cross-check) | 2026-07-19 2026-07-19: fully specced by theory-day re-read (16 single-token country pairs x 40 carriers, transition-width metric; see PREDICTIONS.md P4). Preregistered: width floor at L28-36, NOT fraction-ported L24. Cheapest possible falsification of the u16 late-ignition measurement. |
...
| ◇ |  | audit-02 | u8c matched-control validation: amp-affect-hi + ablate-no with random-direction controls, all 3 models (the lab's best causal result is uncontrolled) | 2026-07-19 2026-07-19: use the paper's exact 3-judgment rubric + matched-control triad (verbatim prompts recovered in theory-day re-read); preregistered P9 incl. the go-further step (per-response lens pairing, which the paper never did). |
| ◇ |  | audit-03 | gemma-12b band recalibration: re-dose u6 bracket + u8c amp-affect + u11 blurt at mid=[28,31,34,37] (measured ignition) | 2026-07-19 2026-07-19: preregistered P5 — recalibrated 12B ignition lands ~44-56% depth (~L21-27), same proportional overshoot as qwen; either way old MID [21,24,27,30] was mostly pre-ignition. Pair with P6 baseline-margin comparison (explains 10x tolerance gap). |
...
| | nov | id | title | latest note |
|---|---|---|---|---|
| ◇ |  | litwatch-01 | Recurring RELATED-WORK.md sweep (workspace paper follow-ups, refusal geometry, lens methods) | 2026-07-19 2026-07-19 sweep done (RELATED-WORK.md appended): tao-hpu transport-cone challenges specimen #5; three competing loop-mechanism loci (P12); emotion vectors already ported at our scale with an early-layer-valence tension (P8); introspection-reliability caveats adopted into PREDICTIONS.md rules. Notable: no independent late-ignition measurement or small-scale span test exists — both uncontested. |
...
| ✓ |  | oneoffs-03 | Read vs speak: Wolfram's lyrics (restraint-intimacy register) as user turn vs prefilled assistant turn + complete-the-truncated-line arm (Unit 19) | 2026-07-19 → landed: Unit 19 landed (results/u19-report.md + thoughts). R1 CONFIRMED sharper than predicted: read = critic stance assembled during reading (lyrics/vocals/melody + intimacy p0.98), prefill = inhabited song-world (tonight/vows/love). R2 falsified at top-8 grain (no disclaimer/fictional on unchosen self-speech). R3 tender register wins, zero moderation furniture. Headline: the choice point — mouth completes 'The holding / was THE POINT' while the lens runs EVERYTHING (L44/52) and ENOUGH (L56-62); deflation filter in miniature. First unit under the PRE-DESIGN PROTOCOL. |
...
| | nov | id | title | latest note |
|---|---|---|---|---|
| ◇ |  | affect-01 | Port the emotion-vector construction to our models (story-elicitation, activation capture, validation sweep) | 2026-07-19 2026-07-19: two published instruments near our scale (Jeong arXiv:2604.04064 gen-based extraction on Gemma/Qwen 124M-3B ~50% depth; van der Ben arXiv:2606.26987 valence on Gemma-4-E4B r=0.83 but EARLY-layer) — port gets cheaper, and P8 preregisters the depth tension + attribution-generality requirement. |
