...
Detected here: 2 language(s), 95 source files.
...
- **General** — Import-graph cluster of 63 files; reinforced by import clustering; reinforced by import clustering · `file:affect08s.py`, `file:affect5.py`, `file:apparatus06.py`
