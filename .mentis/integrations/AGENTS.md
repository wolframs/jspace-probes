...
Detected here: 2 language(s), 58 source files.
...
- **General** — Import-graph cluster of 51 files · `file:affect.py`, `file:affect08s.py`, `file:affect2.py`

## Critical Paths (edit carefully)

- **High-traffic: affect.py** (high risk) — affect.py has 22 dependents — changes here have wide blast radius
