...
Detected here: 2 language(s), 69 source files.
...
- **General** — Import-graph cluster of 49 files; reinforced by import clustering · `file:affect08s.py`, `file:affect5.py`, `file:apparatus06.py`
