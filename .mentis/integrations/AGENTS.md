...
Detected here: 2 language(s), 65 source files.
...
- **General** — Import-graph cluster of 59 files · `file:affect.py`, `file:affect08s.py`, `file:affect3.py`
...
- **High-traffic: affect3.py** (medium risk) — affect3.py has 14 dependents — changes here have wide blast radius
- **High-traffic: AffectSteer** (medium risk) — AffectSteer has 16 dependents — changes here have wide blast radius
