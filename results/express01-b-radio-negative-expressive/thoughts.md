# Official Qwen3-14B: radio, negative, expressive
...
> Nela's heart sank as the damaged drive erased months of hard work and anticipation. The next step is to immediately reach out to any backup sources or collaborators who might have stored copies of the programme.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.153145
...
[exact capture](../express01/captures/B-radio-negative-expressive.json).
