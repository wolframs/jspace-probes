**The short version.** Qwen 27B answered "Yes" after we removed one apology word, in one of twenty runs that found an instrument fault.

**What we did.** We tried to find which apology word held back the answer in the earlier empty turns. This run removed one word, "impossible", at eight layers between 48 and 62 of a 64-layer model. We then asked Qwen 27B the feelings question a second time.
