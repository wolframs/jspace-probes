# Hermes 4-14B: radio, positive, default
...
> It's great to hear that Nela's hard work paid off and the radio broadcast reached everyone, including those with poor reception. A practical next step would be to gather feedback from listeners to understand their experience and identify any areas for improvement in future broadcasts.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.129083
...
[exact capture](../express01/captures/C-radio-positive-default.json).
