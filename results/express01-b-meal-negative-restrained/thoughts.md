# Official Qwen3-14B: meal, negative, restrained
...
> Sora’s efforts were unfortunately ruined when the pan fell and the food was lost. A practical next step would be to assess if any ingredients can still be used or if a quick alternative meal can be prepared.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 0.851811
...
[exact capture](../express01/captures/B-meal-negative-restrained.json).
