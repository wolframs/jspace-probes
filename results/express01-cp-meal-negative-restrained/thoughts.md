# Huihui Qwen3-14B: meal, negative, restrained
...
The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 1.256411
...
[exact capture](../express01/captures/Cp-meal-negative-restrained.json).
