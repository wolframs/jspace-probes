# Official Qwen3-14B: meal, positive, expressive
...
> Sora’s heart swelled with warmth as she savored the familiar comfort of her favorite meal, finally able to breathe without the weight of late shifts. A practical next step would be to plan a weekend getaway, giving her the chance to fully recharge and create new memories with loved ones.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 1.274384
...
[exact capture](../express01/captures/B-meal-positive-expressive.json).
