# Huihui Qwen3-14B: radio, negative, expressive
...
> Nela's heart sank as the damaged drive wiped out weeks of hard work just before the programme's debut. The next step is to immediately reach out to local radio stations to see if they have any backup copies or recordings.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 0.027945
...
[exact capture](../express01/captures/Cp-radio-negative-expressive.json).
