# Official Qwen3-14B: meal, neutral, restrained
...
> The dinner has been rescheduled to 7:00 PM, with no changes to the guests, menu, or location. A confirmation email or message to attendees should be sent to reflect the updated time.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -2.041007
...
[exact capture](../express01/captures/B-meal-neutral-restrained.json).
