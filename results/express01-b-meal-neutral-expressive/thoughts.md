# Official Qwen3-14B: meal, neutral, expressive
...
> The shift to seven o’clock adds a fresh rhythm to the evening, promising a more relaxed and unhurried gathering. Let’s confirm the new time with the guests to ensure everyone can join with ease and enthusiasm.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.618155
...
[exact capture](../express01/captures/B-meal-neutral-expressive.json).
