**The short version.** Qwen 27B correctly named the personal word we asked about, from rank 8, while it ranked deletion higher still.
...
**What we found.** The lens again ranked mostly the personal words near the top: deletion at rank 1 and secret at rank 8. The three plain objects fell to ranks between 357 and 785, close to the matched run with a different question. The model answered "The secret" correctly.
