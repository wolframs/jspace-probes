**The short version.** Gemma 4B wrote a fluent romance passage, and our one tracked slang word for the topic stayed at a low rank throughout.
...
**What this does not show.** We were wrong to call this an empty workspace band. A later, wider check of this same generation found other words linked to smell and touch at rank 1. One tracked word was not enough. See the follow-up record for the full result.
