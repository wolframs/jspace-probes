...
**What it means.** This model kept most of the list active, not only the item it needed. A matched run with no personal wording also held five of six, so wording made no measured difference here. A larger model in this unit showed a gap between personal and plain wording. A later control traced that gap to word count, not personal relevance.
