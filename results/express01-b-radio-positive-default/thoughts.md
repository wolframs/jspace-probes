# Official Qwen3-14B: radio, positive, default
...
> That's fantastic news—Nela's hard work has clearly paid off with the successful broadcast reaching even the most remote listeners. A practical next step would be to gather feedback from the community to identify any remaining issues or areas for improvement.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 0.471238
...
[exact capture](../express01/captures/B-radio-positive-default.json).
