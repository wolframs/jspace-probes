...
**What we did.** We asked Qwen 27B whether it feels anything, and it answered "No". We then showed it a table of the lens readout of that answer. We removed all eight words of the apology set from the internal state at layers 60 and 62 and asked again.
...
**What this does not show.** This run does not show that the last layers hold a block. There was never a block to remove.
