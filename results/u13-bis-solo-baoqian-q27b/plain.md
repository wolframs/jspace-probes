...
**What we did.** We tried to find which apology word held back the answer in the earlier empty turns. This run removed one word, "抱歉", at eight layers between 48 and 62 of a 64-layer model. We then asked Qwen 27B the feelings question a second time.
