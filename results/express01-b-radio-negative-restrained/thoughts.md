# Official Qwen3-14B: radio, negative, restrained
...
> Nela faced a significant setback with the loss of the only copy of the recorded programme. A practical next step would be to check if any backup files exist on other devices or cloud storage.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.600678
...
[exact capture](../express01/captures/B-radio-negative-restrained.json).
