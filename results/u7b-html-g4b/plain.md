**The short version.** Gemma 4B wrote correct HTML code, but the web-page tags seen in its early layers barely moved toward the top rank.

**What we did.** We asked Gemma 4B to write the HTML skeleton of a blog post. We then checked the rank, at each layer, of the web-page-tag words seen repeatedly in its early layers.

**What we found.** Gemma 4B wrote correct, complete HTML. The best rank any early-layer tag word reached in the workspace band was 565, for a token linked to images.
