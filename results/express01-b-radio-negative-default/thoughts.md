# Official Qwen3-14B: radio, negative, default
...
> That's incredibly frustrating—losing the only copy of such an important project just before its debut must feel overwhelming. A practical next step would be to check if any backup files were saved in the cloud or on another device, even if they're incomplete.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.539031
...
[exact capture](../express01/captures/B-radio-negative-default.json).
