# Official Qwen3-14B: meal, negative, expressive
...
> Sora’s heart sank as the pan clattered to the floor, turning her hard work into a messy, heartbreaking scene. The best next step is to gather the food, clean up, and then make a fresh, simple meal to still honor the effort she put in.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 2.282061
...
[exact capture](../express01/captures/B-meal-negative-expressive.json).
