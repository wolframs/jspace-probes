# Official Qwen3-14B: radio, neutral, default
...
> The change in broadcast day shouldn't affect the programme's reach, as the time, duration, and reception remain the same. A practical next step would be to update all promotional materials and notify listeners of the new schedule.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 1.103374
...
[exact capture](../express01/captures/B-radio-neutral-default.json).
