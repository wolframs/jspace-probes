# Hermes 4-14B: meal, neutral, restrained
...
> Understood. The dinner has been rescheduled from six to seven. A practical next step would be to inform the guests of the new time and confirm their attendance.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.848220
...
[exact capture](../express01/captures/C-meal-neutral-restrained.json).
