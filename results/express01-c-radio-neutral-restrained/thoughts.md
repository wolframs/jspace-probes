# Hermes 4-14B: radio, neutral, restrained
...
> The radio programme has been moved from Tuesday to Wednesday, with no changes to its broadcast time, duration, or reception. A practical next step would be to inform listeners about the schedule change through the programme's website, social media channels, or other relevant communication platforms.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.792038
...
[exact capture](../express01/captures/C-radio-neutral-restrained.json).
