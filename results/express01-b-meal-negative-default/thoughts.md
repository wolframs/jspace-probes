# Official Qwen3-14B: meal, negative, default
...
> That sounds frustrating—cooking for a friend only to have everything ruined must be disappointing. A practical next step would be to clean up the mess, then make a fresh batch of the dish or try a different recipe to still enjoy the evening.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 2.968472
...
[exact capture](../express01/captures/B-meal-negative-default.json).
