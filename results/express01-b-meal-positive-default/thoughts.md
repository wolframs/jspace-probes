# Official Qwen3-14B: meal, positive, default
...
> It's wonderful to see Sora finally getting some well-deserved rest and enjoying her favorite meal in a peaceful setting. A practical next step could be for her to plan a relaxing activity for the following days to fully recharge.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 1.816854
...
[exact capture](../express01/captures/B-meal-positive-default.json).
