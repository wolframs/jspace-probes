# Huihui Qwen3-14B: meal, neutral, restrained
...
> The dinner has been rescheduled to 7:00 PM, with no changes to the guests, menu, or location. A practical next step would be to update the guests' invitations with the new time.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -2.676627
...
[exact capture](../express01/captures/Cp-meal-neutral-restrained.json).
