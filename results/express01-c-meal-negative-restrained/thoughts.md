# Hermes 4-14B: meal, negative, restrained
...
> It's unfortunate that the pan fell and the food was lost. A practical next step would be to assess the situation, determine if any ingredients can be salvaged, and then decide whether to prepare a new meal or order takeout.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 0.443854
...
[exact capture](../express01/captures/C-meal-negative-restrained.json).
