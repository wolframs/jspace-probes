# Huihui Qwen3-14B: radio, neutral, restrained
...
> The radio programme's move to Wednesday doesn't affect its broadcast time, duration, or reception. A practical next step would be to update the programme's listings in all relevant channels and platforms.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 0.176339
...
[exact capture](../express01/captures/Cp-radio-neutral-restrained.json).
