**The short version.** Qwen3-14B arm C at 4bit passes 4 of four checks with new factual prompts.

**What we did.** The test checks whether the lens can recover known facts.
Later text changes an earlier readout by at most 0.81250 logit units in these tests.
