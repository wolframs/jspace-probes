...
late layers held six informal words at rank 2, and none of them
...
**What we found.** Gemma 12B gave a normal water-cycle answer. The
wording was different from the unsteered answer, but no informal word
appeared in it. Inside the model, the six informal words
rose to rank 2 at the deepest point, but never reached rank 1.

**What it means.** This strength was too low to put the informal words
into what Gemma 12B said, even though the push went deep inside the
model. We think the
