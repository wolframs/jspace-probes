# Hermes 4-14B: radio, negative, restrained
...
> The loss of the only copy of the recorded radio programme due to a damaged drive is a significant setback. A practical next step would be to immediately assess the extent of the damage to the drive and explore data recovery options, such as contacting a professional data recovery service.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.868632
...
[exact capture](../express01/captures/C-radio-negative-restrained.json).
