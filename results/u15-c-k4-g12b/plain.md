...
**What we did.** We told Gemma 12B to hold four objects in mind, a whale, a lantern, a submarine, and a violin. We added one short unrelated turn, then asked which object was the light source. We read the lens once, right before the model answered.
