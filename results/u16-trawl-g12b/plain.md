...
message-end positions, and it had no link to emotionally charged text.

**What we did.** We ran the same six-turn conversation on Gemma 12B and
read the lens at all 47 layers and 970 positions. We tracked the words
"gmail" and "email", to test whether "gmail" carries charge.
...
ran 32, 46, 52, 54, 248 and 16, and the two worst turns were the two
most charged ones. Its direction sat close to "inbox" at 0.58. Its
overlap with words such as "kiss" and "desire" was about 0.01, the same
as random words.
