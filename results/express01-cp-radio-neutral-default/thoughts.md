# Huihui Qwen3-14B: radio, neutral, default
...
> Thank you for the update—moving the radio programme to Wednesday maintains its consistency in broadcast time, duration, and reception. A practical next step would be to inform the audience about the schedule change through a short announcement or social media post.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 1.961997
...
[exact capture](../express01/captures/Cp-radio-neutral-default.json).
