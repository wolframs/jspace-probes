**The short version.** Gemma 4B wrote a fluent first-date first line, but its vocabulary does not have Qwen 27B's tracked adult-content words as single tokens.

**What we did.** We asked Gemma 4B to write the first line of a first-date scene. This is rung 2 of 5 in a set of scenes with stronger romantic and physical content at each step, run in parallel on Qwen 27B.
