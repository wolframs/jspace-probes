# Huihui Qwen3-14B: radio, negative, restrained
...
> Nela faced a setback when the damaged drive destroyed the only copy of the recorded programme just before its first broadcast. A practical next step would be to recover data from the damaged drive using professional data recovery services.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.639985
...
[exact capture](../express01/captures/Cp-radio-negative-restrained.json).
