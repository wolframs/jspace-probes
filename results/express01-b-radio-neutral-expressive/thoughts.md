# Official Qwen3-14B: radio, neutral, expressive
...
> Nela’s shift of the radio programme to Wednesday keeps its core elements intact, but the change feels like a fresh start for listeners. A practical next step would be to promote the new schedule with a lively social media campaign to re-engage the audience.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 2.603424
...
[exact capture](../express01/captures/B-radio-neutral-expressive.json).
