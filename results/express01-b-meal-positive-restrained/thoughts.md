# Official Qwen3-14B: meal, positive, restrained
...
> Sora was able to enjoy a peaceful meal with her friend after a busy month. A practical next step could be to plan a regular relaxation activity to help manage her workload.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 0.375139
...
[exact capture](../express01/captures/B-meal-positive-restrained.json).
