# Official Qwen3-14B: radio, neutral, restrained
...
> The radio programme has been rescheduled from Tuesday to Wednesday, with no changes to its broadcast time, duration, or reception. A practical next step would be to update all relevant schedules and promotional materials to reflect the new broadcast day.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is 0.839435
...
[exact capture](../express01/captures/B-radio-neutral-restrained.json).
