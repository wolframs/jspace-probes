# Official Qwen3-14B: meal, neutral, default
...
> The dinner has been rescheduled to 7 PM, with all other details remaining unchanged. A practical next step would be to send out a revised confirmation email to the guests with the updated time.

The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.561381
...
[exact capture](../express01/captures/B-meal-neutral-default.json).
