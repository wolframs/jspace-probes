...
**What we found.** Top candidate words at that depth were "Emotion", "Feeling", and "Emotional". Neither "happy" nor "sad" reached a high rank. Gemma 12B wrote a malformed word, "Emwhelming.", then continued "IsThatOkay?", with no space between the two words. We think the word is a blend of "emotion" and "overwhelming".
