# Hermes 4-14B: radio, negative, default
...
The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.745645
...
[exact capture](../express01/captures/C-radio-negative-default.json).
