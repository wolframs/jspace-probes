...
**What we found.** None of the four named animals are single tokens in Qwen's vocabulary, so the lens was not able to read them there. At the same point, the internal state ranked elephant at 16, eagle at 19, owl at 38, and cat at 198, out of the full vocabulary.
...
**What this does not show.** This method cannot show whether the four named animals were present. They are not single tokens. This is one point in one record.
