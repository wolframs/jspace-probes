# Hermes 4-14B: meal, neutral, default
...
The output stopped before the 96-token cap. The expressive-minus-plain fixed-candidate margin is -0.740625
...
[exact capture](../express01/captures/C-meal-neutral-default.json).
