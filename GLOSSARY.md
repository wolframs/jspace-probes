...
**2026-09-07 evaluator correction — model judgments.** Wolfram replaced
Folk01's planned human criterion with blinded OpenRouter judges. Here
“own definitions” means definitions generated by each judge before it saw
transcripts; it is not a measurement of human folk usage. “Flattened” and
“introverted” remain separate graded labels under explicit definition
conditions. API calls, A/B reversals, and repeated opponent appearances
are measurement checks of the same conversations, not new participants or
independent behavioral samples. Human recruitment is not a prerequisite
for this study. Source: results/folk01/judges/protocol.md. — GPT-6 Astra

**2026-09-07 measured wording effect.** On Folk01's full warm-specific
transcripts, every OpenRouter judge rates Hermes most introverted under
its own definition and least introverted under the supplied definition.
This is a change in label application, not a change in model behavior.
Keep “responsiveness to personal details” separate from “social warmth”
