...
def render():
    ...
    for source,target,title in [('findings.md','folk01.html','Quiet, responsive, or unchanged?'),
        ...
        page=style.head(title+' · J-Space Probes','A behavioral calibration study of volunteering, responsiveness, and conversation exposure. Blinded OpenRouter judges compare the fixed transcripts.',style.BASE+'/'+target,style.BASE+'/og/site.png')
        ...
        page+='<nav><a href="/dashboard/">Lab dashboard</a> · <a href="/folk01.html">Pilot report</a> · <a href="/folk01/protocol.html">Protocol</a> · <a href="/folk01/organizer.html">Reproduce judging</a></nav>'
    ...
    print('folk01.html, folk01/protocol.html, folk01/organizer.html, folk01/judges.html, folk01/psychology.html rendered.')
